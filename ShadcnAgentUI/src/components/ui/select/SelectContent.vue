  ...
  <SelectPortal>
    <SelectContent
      ...
      :class="cn(
        ...
        position === 'popper'
          && 'w-[var(--reka-select-trigger-width)] min-w-0 data-[side=bottom]:translate-y-1 data-[side=left]:-translate-x-1 data-[side=right]:translate-x-1 data-[side=top]:-translate-y-1',
