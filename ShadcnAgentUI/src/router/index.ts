  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'agents/review-analysis', redirect: { name: 'ReviewTasks' } },
        { path: 'agents/review-analysis/tasks', name: 'ReviewTasks', component: () => import('@/views/review/ReviewAnalysisView.vue'), props: { section: 'tasks' } },
        { path: 'agents/review-analysis/report', name: 'ReviewReport', component: () => import('@/views/review/ReviewAnalysisView.vue'), props: { section: 'report' } },
        { path: 'agents/review-analysis/evidence', name: 'ReviewEvidence', component: () => import('@/views/review/ReviewAnalysisView.vue'), props: { section: 'evidence' } },
        { path: 'agents/amazon-images', name: 'AmazonImageWorkbench', component: () => import('@/views/amazon/AmazonImageWorkbenchView.vue') },
        { path: 'agents/image-history', name: 'ImageHistory', component: () => import('@/views/image/ImageHistoryView.vue') },
